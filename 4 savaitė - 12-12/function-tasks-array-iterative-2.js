...
{
  const facultyName = "Informatikos fakultetas";
  const filterStudentsByFaculty = students.filter(({ faculty }) => faculty === facultyName);
  filterStudentsByFaculty.length <= 0 ? console.log(`Nėra studentų iš ${facultyName}`) : console.log(filterStudentsByFaculty);
}
console.groupEnd();

console.groupCollapsed("2. Atspausdinti visus Chemijos fakulteto studentus");
{
  const facultyName = "Chemijos fakultetas";
  const filterStudentsByFaculty = students.filter(({ faculty }) => faculty === facultyName);
  filterStudentsByFaculty.length <= 0 ? console.log(`Nėra studentų iš ${facultyName}`) : console.log(filterStudentsByFaculty);
}
console.groupEnd();
...
{
  const facultyName = "Elektros ir elektronikos fakultetas";
  const filterStudentsByFaculty = students.filter(({ faculty }) => faculty === facultyName);
  filterStudentsByFaculty.length <= 0 ? console.log(`Nėra studentų iš ${facultyName}`) : console.log(filterStudentsByFaculty);
}
console.groupEnd();
...
{
  const chooseCourse = 1;
  const filterStudentsByCourse = students.filter(({ course }) => course === chooseCourse);
  filterStudentsByCourse.length <= 0 ? console.log(`Nėra ${chooseCourse} kurso studentų`) : console.log(filterStudentsByCourse);
}
console.groupEnd();

console.groupCollapsed("5. Atspausdinti tik antro kurso studentus");
{
  const chooseCourse = 2;
  const filterStudentsByCourse = students.filter(({ course }) => course === chooseCourse);
  filterStudentsByCourse.length <= 0 ? console.log(`Nėra ${chooseCourse} kurso studentų`) : console.log(filterStudentsByCourse);
}
console.groupEnd();
