...
let sentence1 =
  helpers[3] + helpers[7] + nouns[1] + helpers[7] + helpers[4] + helpers[7] + helpers[0] + helpers[7] + helpers[6] + helpers[7] + nouns[6];
...
let sentence5 = nouns[0] + helpers[7] + helpers[4] + helpers[7] + helpers[2] + helpers[7] + helpers[3] + helpers[7] + nouns[4];
...
let sentence7 =
  helpers[3] + helpers[7] + nouns[4] + helpers[7] + helpers[4] + helpers[7] + helpers[0] + helpers[7] + helpers[6] + helpers[7] + nouns[5];
